...
namespace Bai04
{
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter two fractions: ");
            Console.WriteLine("Enter fraction the first fraction: ");
            a.Nhap();
            Console.WriteLine("Enter fraction the second fraction: ");
            b.Nhap();

            Console.WriteLine
                ("Sum of two fractions: " + (a + b));
            Console.WriteLine
                ("Difference of two fractions: " + (a - b));
            Console.WriteLine
                ("Product of two fractions: " + (a * b));
            Console.WriteLine
                ("Quotient of two fractions: " + (a / b));
